...
1. **Terminological Analysis:** First, list all key scientific terms from the English text and propose their strictly geological (or appropriate domain-specific) translations in the target language. Verify them against your DRR context.
2. **Initial Draft:** Provide an initial translation of the text.
